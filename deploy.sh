...
aws cloudformation package --profile "$PROFILE" --template-file "$DIRNAME"/template.yaml --s3-bucket "$S3_BUCKET" --s3-prefix soccer --output-template-file "$DIRNAME"/output/packaged-template.yaml
